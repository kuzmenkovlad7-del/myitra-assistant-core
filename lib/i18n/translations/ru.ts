...
export const ru: Record<string, string> = {
  ...
  "Waiting... you can start speaking at any moment.": "Ожидаю... вы можете начать говорить в любой момент.",
  "You can start speaking when you're ready. The assistant will answer with voice and text here.": "Можете начать говорить, когда будете готовы. Ассистент будет отвечать голосом и текстом здесь.",
  ...
  "Microphone access was blocked. Please allow it in your browser settings and restart the call.": "Доступ к микрофону был заблокирован. Разрешите его в настройках браузера и перезапустите звонок.",
  "Your browser does not support voice recognition. Please use Chrome or another modern browser.": "Ваш браузер не поддерживает распознавание речи. Пожалуйста, используйте Chrome или другой современный браузер.",
  "Error while listening. Please try again.": "Ошибка во время прослушивания. Попробуйте ещё раз.",
