...
export const uk: Record<string, string> = {
  ...
  "Waiting... you can start speaking at any moment.": "Очікую... ви можете почати говорити в будь-який момент.",
  "You can start speaking when you're ready. The assistant will answer with voice and text here.": "Можете починати говорити, коли будете готові. Асистент відповідатиме голосом і текстом тут.",
  ...
  "Microphone access was blocked. Please allow it in your browser settings and restart the call.": "Доступ до мікрофона було заблоковано. Дозвольте його в налаштуваннях браузера та перезапустіть дзвінок.",
  "Your browser does not support voice recognition. Please use Chrome or another modern browser.": "Ваш браузер не підтримує розпізнавання мовлення. Будь ласка, використовуйте Chrome або інший сучасний браузер.",
  "Error while listening. Please try again.": "Помилка під час прослуховування. Спробуйте ще раз.",
