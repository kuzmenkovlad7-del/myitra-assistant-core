...
export default function LoginPage() {
  ...
  function goRegister() {
    const e1 = email.trim();
    router.push(e1 ? `/register?email=${encodeURIComponent(e1)}` : "/register");
  }
    ...
    <div className="mx-auto flex min-h-[70vh] w-full max-w-md items-center justify-center px-4 py-10">
      <Card className="w-full">
        <CardHeader className="items-center text-center">
          ...
          <p className="text-sm text-muted-foreground">Log in to save sessions and manage access</p>
        </CardHeader>
        ...
        <CardContent>
          <form className="space-y-4" onSubmit={onSubmit}>
            ...
            <div className="flex items-center justify-center gap-2 pt-2 text-sm text-muted-foreground">
              ...
              <Button type="button" variant="outline" onClick={goRegister}>
                Create account
              </Button>
            </div>
          </form>
